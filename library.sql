...
CREATE TABLE ml_authors (
    ...
    FOREIGN KEY(author_book_id) REFERENCES ml_book(book_id) ON DELETE CASCADE ON UPDATE CASCADE
                ...
                /*==========RELLENO DE TABLAS COMIENZO==========*/
/* Los datos están sacados de la tabla original.*/
	INSERT INTO ml_publisher
	...
	INSERT INTO ml_borrower
		(borrower_name, borrower_address, borrower_phoneno)
		VALUES
	...
	INSERT INTO ml_loans
		(loan_book_id, loan_facility_id, loan_borrower_id, loan_dateout, loan_duedate)
		VALUES
	...
	INSERT INTO ml_copies
		(copy_book_id, copy_facility_id, copy_numofcopies)
		VALUES
		('1','1','5'),
		('2','1','5'),
		('3','1','5'),
